...
"Noto Naskh Arabic:pixelsize=22:antialias=true:autohint=true"
};
...
static const char *colorname[] = {
	...
	"#262626", /* default background colour */ // default : black
};
...
#define SCROLLING (MODKEY|ControlMask|ShiftMask)
